...
export default function LogoutPage() {
  ...
  return (
    ...
    <main dir={language === 'ar' ? 'rtl' : 'ltr'} className={`min-h-screen flex flex-col items-center justify-center antialiased p-4 ${isDark ? 'bg-[#121212] text-[#FFFFFF]' : 'bg-[#F8F9FA] text-[#111827]'}`}>
      ...
      <div className="relative flex flex-col items-center z-10 w-full max-w-[310px]">
        ...
        <div className="relative w-20 h-20 mb-8">
          ...
          <div className={`absolute inset-0 border-[3px] rounded-[12px] ${isDark ? 'border-[#2C2C2E]' : 'border-[#E2E4E9]'}`}></div>
        ...
        <div className="text-center space-y-3">
          ...
          <div className={`inline-block px-4 py-1.5 rounded-full border ${isDark ? 'bg-[#222222] border-[#2D2D2F]' : 'bg-[#F0F1F3] border-[#E2E4E9]'}`}>
      ...
      <div className="absolute bottom-12 flex flex-col items-center gap-2">
        {/* divider: #262626 */}
        <div className={`h-[1px] w-8 mb-2 ${isDark ? 'bg-[#262626]' : 'bg-[#EBEDF0]'}`} />
