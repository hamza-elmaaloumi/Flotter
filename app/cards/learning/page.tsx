  ...
  return (
    <div className="min-h-screen bg-[#000000] text-[#FFFFFF] font-['San_Francisco',_sans-serif] antialiased pb-[40px] md:pb-[60px]">
      <div className="max-w-5xl mx-auto px-[16px] md:px-[20px] pt-[20px] md:pt-[32px] relative">
        ...
        <section className={`relative overflow-hidden rounded-[24px] md:rounded-[32px] border transition-all duration-1000 p-6 md:p-12 mb-[20px] md:mb-[32px] ${isFinished ? 'bg-[#121212] border-[#22C55E]/40' : 'bg-[#121212] border-[#1C1C1E]'
          }`}>

          <div className={`absolute top-[-50px] right-[-50px] w-[200px] h-[200px] md:w-[400px] md:h-[400px] blur-[80px] md:blur-[120px] rounded-full transition-all duration-1000 ${isFinished ? 'bg-[#22C55E]/15' : 'bg-[#FF453A]/10'
            }`} />

          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12">
            <div className="flex-1 text-center md:text-left order-2 md:order-1">
              <div className={`inline-flex items-center gap-2 px-3 py-1 md:px-4 md:py-1.5 rounded-full mb-4 md:mb-6 border transition-colors duration-500 ${isFinished ? 'bg-[#22C55E]/10 border-[#22C55E]/20 text-[#22C55E]' : 'bg-[#1C1C1E] border-[#3A3A3C] text-[#3B82F6]'
                }`}>
              ...
              <div className="flex flex-row justify-center md:justify-start gap-3">
                <Link
                  href="/cards/deck"
                  className={`flex-1 md:flex-none inline-flex items-center justify-center gap-2 px-[20px] md:px-[36px] py-[14px] md:py-[18px] rounded-[16px] md:rounded-[22px] font-[700] text-[14px] md:text-[17px] transition-all active:scale-[0.95] ${isFinished
            ...
            <div className="relative w-[140px] h-[140px] md:w-[220px] md:h-[220px] flex items-center justify-center order-1 md:order-2">
              ...
              {/* We use viewBox="0 0 100 100" so the math is ALWAYS based on 100, 
      regardless of the actual pixel size of the div */}
              <svg className="w-full h-full transform -rotate-90 relative z-10 overflow-visible" viewBox="0 0 100 100">
                {/* Background Circle */}
                <circle
                  cx="50" cy="50" r="42"
                  stroke="currentColor" strokeWidth="8"
                  fill={isFinished ? "#22C55E" : "transparent"}
